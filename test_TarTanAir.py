...
dataset = Tartanair_Dataset(root_path="/opt/data/private/dataset/VDSRDataset/TartanAir/", train=False,
                            txt_file="./data/tartanair_test.txt", transform=data_transform, scale=opt.scale)
...
with torch.no_grad():
    ...
    for idx, data in enumerate(dataloader):
        ...
        mae_avg[idx] = calc_mae_tartanair(gt, restored)
        rmse_avg[idx] = calc_rmse_tartanair(gt, restored)
